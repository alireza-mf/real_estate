...
export class SignUp extends Component {
    ...
    onSubmit = (e) => {
        e.preventDefault();
        const { username, password, password2, email, firstName, lastName } = this.state;
        if (password !== password2) { this.props.setAlert({ passwordNotMatch: 'Passwords do not match' });
        } else {
        const newUser = {
            username,
            password,
        ...
        return(
            <div className='auth'>
                ...
                <form className='auth__form' onSubmit={this.onSubmit}>
                    ...
                    <button className='auth__form__button' type='submit'>Register</button>
                </form>
